...
class ControllerModuleSpecialobject extends Controller {
	protected function index($setting) {
		//$this->language->load('module/specialobject'); 
		...
		foreach ($products as $product_id) {
			...
			$this->data['products'][] = array(
				...
				'number_of_rooms_value' => $this->model_catalog_product->getSelectionProductOption($product_info['product_id'], 43),
				'number_of_beds_value' => $this->model_catalog_product->getSelectionProductOption($product_info['product_id'], 48),
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/specialobject.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/specialobject.tpl';
		} else {
			$this->template = 'default/template/module/specialobject.tpl';
		}
