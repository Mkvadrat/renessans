	...
	protected function index() {
		...
		if (isset($this->session->data['error']) && !empty($this->session->data['error'])) {
			...
			$this->data['error'] = '';
                ...
                //$this->data['sales'] = $this->url->link('sales/sales', '', 'SSL');
				$this->data['sales'] = $this->url->link('product/category&path=20', '', 'SSL');
                //$this->data['arenda'] = $this->url->link('arenda/arenda', '', 'SSL');
				$this->data['arenda'] = $this->url->link('product/category&path=18', '', 'SSL');
                $this->data['about'] = $this->url->link('about/about', '', 'SSL');
				$this->data['services'] = $this->url->link('services/services', '', 'SSL');
                $this->data['importent'] = $this->url->link('importent/importent', '', 'SSL');
                $this->data['novostroy'] = $this->url->link('novostroy/novostroy', '', 'SSL');
        ...
        $this->data['request_uri'] = rtrim($_SERVER['REQUEST_URI'],'/');
