...
class ControllerServicesServices extends Controller {
	public function index() {
		...
		$this->data['article_1'] = $this->url->link('information/information&information_id=65', '', 'SSL');
		$this->data['article_2'] = $this->url->link('information/information&information_id=66', '', 'SSL');
		$this->data['article_3'] = $this->url->link('information/information&information_id=67', '', 'SSL');
		$this->data['article_4'] = $this->url->link('information/information&information_id=68', '', 'SSL');
		$this->data['article_5'] = $this->url->link('information/information&information_id=69', '', 'SSL');
