    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <tr>
              <td><div class="image"><img src="<?php echo $thumb; ?>" alt="" id="thumb" /><br />
                  ...
                  <a onclick="image_upload('image', 'thumb');"><?php echo $text_image; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb').attr('src', '<?php echo $no_image; ?>'); $('#image').attr('value', '<?php echo $no_image; ?>');"><?php echo $text_image_clear; ?></a></div></td>
			</tr>
		  ...
		  <?php }else{ ?>
		  <input name="user_group_id" type="hidden" value="11">
		  <?php } ?>
          <tr>
