				...
				<ul class="mainnav">
					...
					<li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
						<ul>
							...
							<?php if($getblock){ ?>
							<li><a href="<?php echo $testimonial; ?>"><?php echo $text_review; ?></a></li>
							<li><a href="<?php echo $information; ?>"><?php echo $text_information; ?></a></li>
                            <li><a href="<?php echo $gallery; ?>">Галерея</a></li>
							<li><a href="<?php echo $actionobject; ?>"><?php echo $text_actionobject; ?></a></li>
							<?php } ?>
						</ul>
					</li>
					...
					<li id="system"><a class="top"><?php echo $text_system; ?></a>
						<ul>
							...
							<li><a href="<?php echo $excel; ?>"><?php echo $text_excel; ?></a></li>
