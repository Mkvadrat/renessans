...
<script language="javascript">
	...
	<!--
    <br>
    <div class="buttons"><a onclick="apply_ajax()" class="button"><span>Скрипт ajax</span></a></div>
<script language="javascript">
    function apply_ajax(){
        //alert ('jQuery подключен и отлично работает!');
	   $.ajax({
		url: 'index.php?route=catalog/product/getApplyButton&token=<?php echo $token; ?>&product_id=<?php echo $product_id; ?>',
		type: 'POST',
		data: $('<input type="hidden" id="apply_save" name="apply_save" value="1"  />'),
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><?php if($getblock){?><a href="#tab-special"><?php echo $tab_special; ?></a><?php } ?><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-video">Видео</a><a href="#tab-plan">Планировки</a><?php if($getblock){ ?><a href="#tab-design"><?php echo $tab_design; ?></a><?php } ?></div>
