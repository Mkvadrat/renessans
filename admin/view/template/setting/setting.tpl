    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><textarea name="config_address" cols="40" rows="5"><?php echo $config_address; ?></textarea>
                ...
                <?php } ?></td>
              <td><?php if ($config_display_address) { ?>
                <input type="radio" name="config_display_address" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_address" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_address" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_address" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_display_address; ?></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="config_email" value="<?php echo $config_email; ?>" size="40" />
                ...
                <?php } ?></td>
			  <td><?php if ($config_display_email) { ?>
                <input type="radio" name="config_display_email" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_email" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_email" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_email" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_display_email; ?></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="config_telephone" value="<?php echo $config_telephone; ?>" />
                ...
                <?php } ?></td>
			  <td><?php if ($config_display_telephone) { ?>
                <input type="radio" name="config_display_telephone" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_telephone" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_telephone" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_telephone" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_display_telephone; ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_fax; ?></td>
              <td width="200"><input type="text" name="config_fax" value="<?php echo $config_fax; ?>" /></td>
			  <td width="100"><?php if ($config_display_fax) { ?>
                <input type="radio" name="config_display_fax" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_fax" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_fax" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_fax" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_display_fax; ?></td>
            </tr>
			<tr>
              <td>Кнопки социальных сетей:</td>
              <td width="200"><input type="text" name="social_button" value="<?php echo $social_button; ?>" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-store">
          <table class="form">
            <tr>
              ...
              <td width="250"><input type="text" name="config_title" value="<?php echo $config_title; ?>" />
                <?php if ($error_title) { ?>
            ...
            <tr>
			  ...
			  <td><?php echo $info_meta_description; ?></td>
            </tr>
			<tr>
              <td><?php echo $entry_meta_keyword; ?></td>
              <td><textarea name="config_meta_keyword" cols="40" rows="2"><?php echo $config_meta_keyword; ?></textarea></td>
			  <td><?php echo $info_meta_keyword; ?></td>
            </tr>
		  </table>
		  <table class="form">
            <tr>
        ...
        <div id="tab-local">
          <table class="form">
            ...
            <tr>
			  ...
			  <td><?php echo $info_currency; ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_currency_auto; ?></td>
              <td width="150"><?php if ($config_currency_auto) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_currency_auto; ?></td>
            </tr>
            <tr>
        ...
        <div id="tab-option">
          ...
          <table class="form">
            <tr>
              <td><?php echo $entry_type_menu; ?></td>
			  <td width="250"><?php if ($config_main_menu) { ?>
                <input type="radio" name="config_main_menu" value="1" checked="checked" />
                <?php echo $text_menu_advanted; ?>
                <input type="radio" name="config_main_menu" value="0" />
                <?php echo $text_menu_default; ?>
                <?php } else { ?>
                <input type="radio" name="config_main_menu" value="1" />
                <?php echo $text_menu_advanted; ?>
                <input type="radio" name="config_main_menu" value="0" checked="checked" />
                <?php echo $text_menu_default; ?>
                <?php } ?></td>
			  <td><?php echo $info_type_menu; ?></td>
            </tr>
			<tr>
              ...
              <td><?php if ($config_product_count) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_product_count; ?></td>
            </tr>
		  </table>
          ...
          <table class="form">
			<tr>
              ...
              <td width="250"><input type="text" name="config_catalog_limit" value="<?php echo $config_catalog_limit; ?>" size="3" />
                <?php if ($error_catalog_limit) { ?>
                <span class="error"><?php echo $error_catalog_limit; ?></span>
                <?php } ?></td>
			  <td><?php echo $info_catalog_limit; ?></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="config_admin_limit" value="<?php echo $config_admin_limit; ?>" size="3" />
                ...
                <?php } ?></td>
			  <td><?php echo $info_admin_limit; ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><?php if ($config_review_status) { ?>
            ...
            <tr>
			  ...
			  <td><?php echo $info_upload_allowed; ?></td>
            </tr>
          </table>
		  <h2><?php echo $text_data_display; ?></h2>
          <table class="form">
			<tr>
			...
			<tr>
              <td><?php echo $entry_display_location; ?></td>
			...
			<tr>
              <td><?php echo $entry_display_sku; ?></td>
			...
			<tr>
              <td><?php echo $entry_display_ups; ?></td>
			...
			<tr>
              <td><?php echo $entry_display_ean; ?></td>
              <td><?php if ($config_display_ean) { ?>
                <input type="radio" name="config_display_ean" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_ean" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_ean" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_ean" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td></td>
            </tr>
			<tr>
              <td><?php echo $entry_display_jan; ?></td>
              <td><?php if ($config_display_jan) { ?>
                <input type="radio" name="config_display_jan" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_jan" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_jan" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_jan" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td></td>
            </tr>
			<tr>
              <td><?php echo $entry_display_isbn; ?></td>
              <td><?php if ($config_display_isbn) { ?>
                <input type="radio" name="config_display_isbn" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_isbn" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_isbn" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_isbn" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td></td>
            </tr>
			<tr>
              <td><?php echo $entry_display_mpn; ?></td>
              <td><?php if ($config_display_mpn) { ?>
                <input type="radio" name="config_display_mpn" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_mpn" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_display_mpn" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_display_mpn" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td></td>
            </tr>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><input type="text" name="config_voucher_min" value="<?php echo $config_voucher_min; ?>" />
                <?php if ($error_voucher_min) { ?>
                <span class="error"><?php echo $error_voucher_min; ?></span>
                <?php } ?></td>
			  <td><?php echo $info_voucher_min; ?></td>
            </tr>
            <tr>
              ...
              <td><input type="text" name="config_voucher_max" value="<?php echo $config_voucher_max; ?>" />
                ...
                <?php } ?></td>
			  <td><?php echo $info_voucher_max; ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><?php if ($config_tax) { ?>
            ...
            <tr>
			  ...
			  <td><?php echo $info_tax_default; ?></td>
            </tr>
            <tr>
			  ...
			  <td><?php echo $info_tax_customer; ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><?php if ($config_customer_online) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_customer_online; ?></td>
            </tr>          
            <tr>
			  ...
			  <td><?php echo $info_customer_group; ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_customer_group_display; ?></td>
              <td><div class="scrollbox" style="width:250px;">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($customer_groups as $customer_group) { ?>
                ...
                <?php } ?></td>
			  <td><?php echo $info_customer_group_display; ?></td>
            </tr>
            <tr>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><?php if ($config_cart_weight) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_cart_weight; ?></td>
            </tr>
            <tr>
              ...
              <td><?php if ($config_guest_checkout) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_guest_checkout; ?></td>
            </tr>
            <tr>
            ...
            <tr>
			  ...
			  <td><?php echo $info_order_status; ?></td>
            </tr>
            <tr>
			  ...
			  <td><?php echo $info_complete_status; ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><?php if ($config_stock_display) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_stock_display; ?></td>
            </tr>
            <tr>
              ...
              <td><?php if ($config_stock_warning) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_stock_warning; ?></td>
            </tr>
            <tr>
              ...
              <td><?php if ($config_stock_checkout) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_stock_checkout; ?></td>
            </tr>
            <tr>
			  ...
			  <td><?php echo $info_stock_status; ?></td>
            </tr>
          </table>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><select name="config_affiliate_id">
                  <option value="0"><?php echo $text_none; ?></option>
                  <?php foreach ($informations as $information) { ?>
          ...
          <table class="form">
            <tr>
              ...
              <td width="250"><select name="config_return_status_id">
			  ...
			  <td><?php echo $info_return_status; ?></td>
            </tr>
          </table>
        </div>
        <div id="tab-image">
          <table class="form">
            ...
            <tr>
              ...
              <td width="150"><div class="image"><img src="<?php echo $icon; ?>" alt="" id="thumb-icon" />
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><?php if ($config_alert_mail) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_alert_mail; ?></td>
            </tr>
            <tr>
              ...
              <td><?php if ($config_account_mail) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_account_mail; ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_alert_emails; ?></td>
              <td width="250"><textarea name="config_alert_emails" cols="40" rows="5"><?php echo $config_alert_emails; ?></textarea></td>
			  <td><?php echo $info_alert_emails; ?></td>
            </tr>
          </table>
        </div>
        <div id="tab-fraud">
          <table class="form">
            <tr>
              ...
              <td><?php if ($config_fraud_detection) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_fraud_detection; ?></td>
            </tr>          
            <tr>
            ...
            <tr>
			  ...
			  <td><?php echo $info_fraud_score; ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_fraud_status; ?></td>
              <td width="200"><select name="config_fraud_status_id">
                  <?php foreach ($order_statuses as $order_status) { ?>
			  ...
			  <td><?php echo $info_fraud_status; ?></td>
            </tr>            
          </table>
        </div>
        <div id="tab-sms">
          <table class="form">
            ...
            <tr>
              ...
              <td width="250"><input type="text" name="config_sms_gate_password" value="<?php echo $config_sms_gate_password; ?>" /></td>
			  <td></td>
            </tr>
          </table>
        </div>
		<div id="tab-news">
          <table class="form">
			<tr>
              <td><span class="required">*</span> <?php echo $entry_image_ncategory; ?></td>
              <td><input type="text" name="config_image_ncategory_width" value="<?php echo $config_image_ncategory_width; ?>" size="3" />
                x
                <input type="text" name="config_image_ncategory_height" value="<?php echo $config_image_ncategory_height; ?>" size="3" />
                <?php if ($error_image_ncategory) { ?>
                <span class="error"><?php echo $error_image_ncategory; ?></span>
                <?php } ?></td>
			  <td></td>
            </tr>
			<tr>
			  <td><span class="required">*</span> <?php echo $text_bnews_image; ?></td>
			  <td><input type="text" name="config_bnews_image_width" value="<?php echo $config_bnews_image_width; ?>" size="3" />
				x
                <input type="text" name="config_bnews_image_height" value="<?php echo $config_bnews_image_height; ?>" size="3" />
                <?php if ($error_image_bnews) { ?>
                <span class="error"><?php echo $error_image_bnews; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>
			<tr>
			  <td><span class="required">*</span> <?php echo $text_bnews_thumb; ?></td>
			  <td><input type="text" name="config_bnews_thumb_width" value="<?php echo $config_bnews_thumb_width; ?>" size="3" />
				x
                <input type="text" name="config_bnews_thumb_height" value="<?php echo $config_bnews_thumb_height; ?>" size="3" />
                <?php if ($error_thumb_bnews) { ?>
                <span class="error"><?php echo $error_thumb_bnews; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>	
			<tr>
			  <td><?php echo $text_bnews_order; ?></td>
			  <td><?php if ($config_bnews_order) { ?>
				<input type="radio" name="config_bnews_order" value="1" checked="checked" />
				<?php echo $text_yess; ?>
				<input type="radio" name="config_bnews_order" value="0" />
				<?php echo $text_noo; ?>
				<?php } else { ?>
				<input type="radio" name="config_bnews_order" value="1" />
				<?php echo $text_yess; ?>
				<input type="radio" name="config_bnews_order" value="0" checked="checked" />
				<?php echo $text_noo; ?>
				<?php } ?></td>
			  <td><?php echo $info_bnews_order; ?></td>
		    </tr>
			<tr>
			  <td style="width:360px"><span class="required">*</span> <?php echo $text_mod_news; ?></td>
			  <td><input type="text" name="config_mod_news" value="<?php echo $config_mod_news; ?>" size="3" />
                <?php if ($error_mod_news) { ?>
                <span class="error"><?php echo $error_mod_news; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>
			<tr>
			  <td><span class="required">*</span> <?php echo $text_mod_news_side; ?></td>
			  <td><input type="text" name="config_mod_news_side" value="<?php echo $config_mod_news_side; ?>" size="3" />
                <?php if ($error_mod_news_side) { ?>
                <span class="error"><?php echo $error_mod_news_side; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>
			<tr>
			  <td><span class="required">*</span> <?php echo $text_symbols_headlines; ?></td>
			  <td><input type="text" name="config_symbols_headlines" value="<?php echo $config_symbols_headlines; ?>" size="3" />
                <?php if ($error_symbols_headlines) { ?>
                <span class="error"><?php echo $error_symbols_headlines; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>
			<tr>
			  <td><span class="required">*</span> <?php echo $text_symbols_ncategory; ?></td>
			  <td><input type="text" name="config_symbols_ncategory" value="<?php echo $config_symbols_ncategory; ?>" size="3" />
                <?php if ($error_symbols_ncategory) { ?>
                <span class="error"><?php echo $error_symbols_ncategory; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>
			<tr>
			  <td><span class="required">*</span> <?php echo $text_symbols_nsearch; ?></td>
			  <td width="250"><input type="text" name="config_symbols_nsearch" value="<?php echo $config_symbols_nsearch; ?>" size="3" />
                <?php if ($error_symbols_nsearch) { ?>
                <span class="error"><?php echo $error_symbols_nsearch; ?></span>
                <?php } ?></td>
			  <td></td>
		    </tr>
		  </table>
          ...
          <table class="form">
			...
			<tr>
              ...
              <td><?php if ($config_maintenance) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_maintenance; ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php if ($config_seo_url_include_path) { ?>
                ...
                <?php echo $text_no; ?>
                <?php } ?></td>
			  <td><?php echo $info_seo_url_include_path; ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="250"><textarea name="config_google_analytics" cols="40" rows="5"><?php echo $config_google_analytics; ?></textarea></td>
			  <td><?php echo $info_google_analytics; ?></td>
            </tr>
          </table>
        </div>
      </form>
