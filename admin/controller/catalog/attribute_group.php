...
class ControllerCatalogAttributeGroup extends Controller { 
	private $error = array();
  	...
  	private function getForm() {
		...
		$this->data['entry_column_row'] = $this->language->get('entry_column_row');
		...
		if (isset($this->request->post['column_row'])) {
			$this->data['column_row'] = $this->request->post['column_row'];
		} elseif (!empty($attribute_group_info)) {
			$this->data['column_row'] = $attribute_group_info['column_row'];
		} else {
			$this->data['column_row'] = '';
		}
