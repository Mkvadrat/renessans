...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['heading_title_settings'] = $this->language->get('heading_title_settings');
		...
		$this->data['text_data_display'] = $this->language->get('text_data_display');
		...
		$this->data['text_menu_advanted'] = $this->language->get('text_menu_advanted');
		...
		$this->data['text_mod_news'] = $this->language->get('text_mod_news');
		$this->data['text_mod_news_side'] = $this->language->get('text_mod_news_side');
		$this->data['text_symbols_headlines'] = $this->language->get('text_symbols_headlines');
		$this->data['text_symbols_ncategory'] = $this->language->get('text_symbols_ncategory');
		$this->data['text_symbols_nsearch'] = $this->language->get('text_symbols_nsearch');
		...
		$this->data['entry_display_location'] = $this->language->get('entry_display_location');
		$this->data['entry_display_sku'] = $this->language->get('entry_display_sku');
		$this->data['entry_display_ups'] = $this->language->get('entry_display_ups');
		$this->data['entry_display_ean'] = $this->language->get('entry_display_ean');
		$this->data['entry_display_jan'] = $this->language->get('entry_display_jan');
		$this->data['entry_display_isbn'] = $this->language->get('entry_display_isbn');
		$this->data['entry_display_mpn'] = $this->language->get('entry_display_mpn');
		...
		$this->data['entry_type_menu'] = $this->language->get('entry_type_menu');
		...
		$this->data['entry_image_ncategory'] = $this->language->get('entry_image_ncategory');
		...
		$this->data['info_currency'] = $this->language->get('info_currency');
		$this->data['info_currency_auto'] = $this->language->get('info_currency_auto');
		$this->data['info_meta_description'] = $this->language->get('info_meta_description');
		$this->data['info_meta_keyword'] = $this->language->get('info_meta_keyword');
		$this->data['info_type_menu'] = $this->language->get('info_type_menu');
		$this->data['info_product_count'] = $this->language->get('info_product_count');
		$this->data['info_catalog_limit'] = $this->language->get('info_catalog_limit');
		$this->data['info_admin_limit'] = $this->language->get('info_admin_limit');
		$this->data['info_review'] = $this->language->get('info_review');
		$this->data['info_upload_allowed'] = $this->language->get('info_upload_allowed');
		$this->data['info_voucher_min'] = $this->language->get('info_voucher_min');
		$this->data['info_voucher_max'] = $this->language->get('info_voucher_max');
		$this->data['info_vat'] = $this->language->get('info_vat');
		$this->data['info_tax_default'] = $this->language->get('info_tax_default');
		$this->data['info_tax_customer'] = $this->language->get('info_tax_customer');
		$this->data['info_customer_online'] = $this->language->get('info_customer_online');
		$this->data['info_customer_group'] = $this->language->get('info_customer_group');
		$this->data['info_customer_group_display'] = $this->language->get('info_customer_group_display');
		$this->data['info_account'] = $this->language->get('info_account');
		$this->data['info_cart_weight'] = $this->language->get('info_cart_weight');
		$this->data['info_guest_checkout'] = $this->language->get('info_guest_checkout');
		$this->data['info_checkout'] = $this->language->get('info_checkout');
		$this->data['info_order_edit'] = $this->language->get('info_order_edit');
		$this->data['info_invoice_prefix'] = $this->language->get('info_invoice_prefix');
		$this->data['info_order_status'] = $this->language->get('info_order_status');
		$this->data['info_complete_status'] = $this->language->get('info_complete_status');
		$this->data['info_stock_display'] = $this->language->get('info_stock_display');
		$this->data['info_stock_warning'] = $this->language->get('info_stock_warning');
		$this->data['info_stock_checkout'] = $this->language->get('info_stock_checkout');
		$this->data['info_stock_status'] = $this->language->get('info_stock_status');
		$this->data['info_affiliate'] = $this->language->get('info_affiliate');
		$this->data['info_commission'] = $this->language->get('info_commission');
		$this->data['info_return_status'] = $this->language->get('info_return_status');
		$this->data['info_mail_protocol'] = $this->language->get('info_mail_protocol');
		$this->data['info_mail_parameter'] = $this->language->get('info_mail_parameter');
		$this->data['info_alert_mail'] = $this->language->get('info_alert_mail');
		$this->data['info_account_mail'] = $this->language->get('info_account_mail');
		$this->data['info_alert_emails'] = $this->language->get('info_alert_emails');
		$this->data['info_fraud_detection'] = $this->language->get('info_fraud_detection');
		$this->data['info_fraud_score'] = $this->language->get('info_fraud_score');
		$this->data['info_fraud_status'] = $this->language->get('info_fraud_status');
		$this->data['info_sms_from'] = $this->language->get('info_sms_from');
		$this->data['info_sms_to'] = $this->language->get('info_sms_to');
		$this->data['info_sms_copy'] = $this->language->get('info_sms_copy');
		$this->data['info_sms_message'] = $this->language->get('info_sms_message');
		$this->data['info_bnews_order'] = $this->language->get('info_bnews_order');
		$this->data['info_use_ssl'] = $this->language->get('info_use_ssl');
		$this->data['info_maintenance'] = $this->language->get('info_maintenance');
		$this->data['info_seo_url'] = $this->language->get('info_seo_url');
		$this->data['info_seo_url_include_path'] = $this->language->get('info_seo_url_include_path');
		$this->data['info_seo_url_postfix'] = $this->language->get('info_seo_url_postfix');
		$this->data['info_encryption'] = $this->language->get('info_encryption');
		$this->data['info_compression'] = $this->language->get('info_compression');
		$this->data['info_google_analytics'] = $this->language->get('info_google_analytics');
		$this->data['info_icon'] = $this->language->get('info_icon');		
		$this->data['info_display_address'] = $this->language->get('info_display_address');	
		$this->data['info_display_email'] = $this->language->get('info_display_email');	
		$this->data['info_display_telephone'] = $this->language->get('info_display_telephone');	
		$this->data['info_display_fax'] = $this->language->get('info_display_fax');	
		...
		$this->data['tab_news'] = $this->language->get('tab_news');
		...
		if (isset($this->error['image_ncategory'])) {
			$this->data['error_image_ncategory'] = $this->error['image_ncategory'];
		} else {
			$this->data['error_image_ncategory'] = '';
		}
		
		if (isset($this->error['image_bnews'])) {
			$this->data['error_image_bnews'] = $this->error['image_bnews'];
		} else {
			$this->data['error_image_bnews'] = '';
		}
		
		if (isset($this->error['thumb_bnews'])) {
			$this->data['error_thumb_bnews'] = $this->error['thumb_bnews'];
		} else {
			$this->data['error_thumb_bnews'] = '';
		}
		
		if (isset($this->error['mod_news'])) {
			$this->data['error_mod_news'] = $this->error['mod_news'];
		} else {
			$this->data['error_mod_news'] = '';
		}
		
		if (isset($this->error['mod_news_side'])) {
			$this->data['error_mod_news_side'] = $this->error['mod_news_side'];
		} else {
			$this->data['error_mod_news_side'] = '';
		}
		
		if (isset($this->error['symbols_headlines'])) {
			$this->data['error_symbols_headlines'] = $this->error['symbols_headlines'];
		} else {
			$this->data['error_symbols_headlines'] = '';
		}
		
		if (isset($this->error['symbols_ncategory'])) {
			$this->data['error_symbols_ncategory'] = $this->error['symbols_ncategory'];
		} else {
			$this->data['error_symbols_ncategory'] = '';
		}
		...
		if (isset($this->error['symbols_nsearch'])) {
			$this->data['error_symbols_nsearch'] = $this->error['symbols_nsearch'];
		} else {
			$this->data['error_symbols_nsearch'] = '';
		}
		...
		if (isset($this->request->post['config_display_address'])) {
			$this->data['config_display_address'] = $this->request->post['config_display_address'];
		} else {
			$this->data['config_display_address'] = $this->config->get('config_display_address');
		}
		...
		if (isset($this->request->post['config_display_telephone'])) {
			$this->data['config_display_telephone'] = $this->request->post['config_display_telephone'];
		} else {
			$this->data['config_display_telephone'] = $this->config->get('config_display_telephone');
		}
		...
		if (isset($this->request->post['social_button'])) {
			$this->data['social_button'] = $this->request->post['social_button'];
		} else {
			$this->data['social_button'] = $this->config->get('social_button');
		}
		
		if (isset($this->request->post['config_display_fax'])) {
			$this->data['config_display_fax'] = $this->request->post['config_display_fax'];
		} else {
			$this->data['config_display_fax'] = $this->config->get('config_display_fax');
		}
		...
		if (isset($this->request->post['config_main_menu'])) {
			$this->data['config_main_menu'] = $this->request->post['config_main_menu'];
		} else {
			$this->data['config_main_menu'] = $this->config->get('config_main_menu');			
		}
		...
		if (isset($this->request->post['config_display_ean'])) {
			$this->data['config_display_ean'] = $this->request->post['config_display_ean'];
		} else {
			$this->data['config_display_ean'] = $this->config->get('config_display_ean');
		}
		...
		if (isset($this->request->post['config_display_isbn'])) {
			$this->data['config_display_isbn'] = $this->request->post['config_display_isbn'];
		} else {
			$this->data['config_display_isbn'] = $this->config->get('config_display_isbn');
		}
		
		if (isset($this->request->post['config_display_jan'])) {
			$this->data['config_display_jan'] = $this->request->post['config_display_jan'];
		} else {
			$this->data['config_display_jan'] = $this->config->get('config_display_jan');
		}
		
		if (isset($this->request->post['config_display_mpn'])) {
			$this->data['config_display_mpn'] = $this->request->post['config_display_mpn'];
		} else {
			$this->data['config_display_mpn'] = $this->config->get('config_display_mpn');
		}
		...
		// News
		if (isset($this->request->post['config_image_ncategory_width'])) {
			$this->data['config_image_ncategory_width'] = $this->request->post['config_image_ncategory_width'];
		} else {
			$this->data['config_image_ncategory_width'] = $this->config->get('config_image_ncategory_width');
		}
		
		if (isset($this->request->post['config_image_ncategory_height'])) {
			$this->data['config_image_ncategory_height'] = $this->request->post['config_image_ncategory_height'];
		} else {
			$this->data['config_image_ncategory_height'] = $this->config->get('config_image_ncategory_height');
		}
		
		if (isset($this->request->post['config_bnews_image_width'])) {
			$this->data['config_bnews_image_width'] = $this->request->post['config_bnews_image_width'];
		} else {
			$this->data['config_bnews_image_width'] = $this->config->get('config_bnews_image_width');
		}
		
		if (isset($this->request->post['config_bnews_image_height'])) {
			$this->data['config_bnews_image_height'] = $this->request->post['config_bnews_image_height'];
		} else {
			$this->data['config_bnews_image_height'] = $this->config->get('config_bnews_image_height');
		}
		
		if (isset($this->request->post['config_bnews_thumb_width'])) {
			$this->data['config_bnews_thumb_width'] = $this->request->post['config_bnews_thumb_width'];
		} else {
			$this->data['config_bnews_thumb_width'] = $this->config->get('config_bnews_thumb_width');
		}
		
		if (isset($this->request->post['config_bnews_thumb_height'])) {
			$this->data['config_bnews_thumb_height'] = $this->request->post['config_bnews_thumb_height'];
		} else {
			$this->data['config_bnews_thumb_height'] = $this->config->get('config_bnews_thumb_height');
		}
		
		if (isset($this->request->post['config_bnews_order'])) {
			$this->data['config_bnews_order'] = $this->request->post['config_bnews_order'];
		} else {
			$this->data['config_bnews_order'] = $this->config->get('config_bnews_order');
		}
		
		if (isset($this->request->post['config_mod_news'])) {
			$this->data['config_mod_news'] = $this->request->post['config_mod_news'];
		} else {
			$this->data['config_mod_news'] = $this->config->get('config_mod_news');
		}
		
		if (isset($this->request->post['config_mod_news_side'])) {
			$this->data['config_mod_news_side'] = $this->request->post['config_mod_news_side'];
		} else {
			$this->data['config_mod_news_side'] = $this->config->get('config_mod_news_side');
		}
		
		if (isset($this->request->post['config_symbols_headlines'])) {
			$this->data['config_symbols_headlines'] = $this->request->post['config_symbols_headlines'];
		} else {
			$this->data['config_symbols_headlines'] = $this->config->get('config_symbols_headlines');
		}
		
		if (isset($this->request->post['config_symbols_ncategory'])) {
			$this->data['config_symbols_ncategory'] = $this->request->post['config_symbols_ncategory'];
		} else {
			$this->data['config_symbols_ncategory'] = $this->config->get('config_symbols_ncategory');
		}
		
		if (isset($this->request->post['config_symbols_nsearch'])) {
			$this->data['config_symbols_nsearch'] = $this->request->post['config_symbols_nsearch'];
		} else {
			$this->data['config_symbols_nsearch'] = $this->config->get('config_symbols_nsearch');
		}
	...
	private function validate() {
		...
		if (!$this->request->post['config_image_ncategory_width'] || !$this->request->post['config_image_ncategory_height']) {
			$this->error['image_ncategory'] = $this->language->get('error_image_ncategory');
		} 
		
		if (!$this->request->post['config_bnews_image_width'] || !$this->request->post['config_bnews_image_height']) {
			$this->error['image_bnews'] = $this->language->get('error_image_bnews');
		} 
		
		if (!$this->request->post['config_bnews_thumb_width'] || !$this->request->post['config_bnews_thumb_height']) {
			$this->error['thumb_bnews'] = $this->language->get('error_thumb_bnews');
		} 
		
		if (!$this->request->post['config_mod_news']) {
			$this->error['mod_news'] = $this->language->get('error_mod_news');
		} 
		
		if (!$this->request->post['config_mod_news_side']) {
			$this->error['mod_news_side'] = $this->language->get('error_mod_news_side');
		}
		
		if (!$this->request->post['config_symbols_headlines']) {
			$this->error['symbols_headlines'] = $this->language->get('error_symbols_headlines');
		}
		
		if (!$this->request->post['config_symbols_ncategory']) {
			$this->error['symbols_ncategory'] = $this->language->get('error_symbols_ncategory');
		}
		
		if (!$this->request->post['config_symbols_nsearch']) {
			$this->error['symbols_nsearch'] = $this->language->get('error_symbols_nsearch');
		}
