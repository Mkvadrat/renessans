...
$_['button_save_continue']    = 'Применить';
...
$_['button_update_total']     = 'Обновить';
$_['button_approve']          = 'Активировать';
$_['button_reset']            = 'Сброс';
$_['button_excel']            = 'Экспорт';
...
// Info
$_['info_keyword']           = '<span class="help">Должен быть уникальным во всем магазине.</span>';
$_['info_image']             = '<span class="help">Нажмите "Обзор" для добавления изображения, либо "Очистить" для отмены добавленного изображения.</span>';
